...
The residual plot in Figure 2 is produces no definite or identifying pattern as predictors of MPG.
...
2. "Quantify the MPG difference between automatic and manual transmissions" - above data analysis presents basic quantification of MPG difference based on transmission type. The analysis proves that  above other variables like cylinders, weight and displacement would offer better correlation and causation with MPG.
